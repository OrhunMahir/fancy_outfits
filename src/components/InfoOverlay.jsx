    ...
    <div className="overlay">
      <div className="box panel">
        ...
        <div style={{fontSize:9,marginBottom:12,lineHeight:2}}>
          ...
          The workday runs 09:00 to 17:00 and every piece of work COSTS HOURS — errands 1h, real cases 2h, court 3h, delegation 0.5h. Out of hours with files still burning? Take OVERTIME: +2 hours, +12 FATIGUE. Fatigue drags every risky play down (up to −15%) and only sleep clears it — leave early and you recover faster. Bosses will also interrupt your day with chores; refusing is noted, obeying is tiring. Cases have deadlines — miss one and it costs you. Some moves get a reply days later. Court cases have judges with tempers: check their stats before you perform.<br/><br/>
