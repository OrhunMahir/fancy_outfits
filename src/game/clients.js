...
export const CLIENT_NAMES=["Abibas","Mike Sportswear","Pumba Athletics","Starbux Coffee","McRonald's","Panasonique","Dolce & Banana","Rolexx Timepieces","KFG — Kentucky Fried Gravy","Guccy","Microsofa","Goggle","Amazun Logistics","Tesler Motors","Koka-Kola Bottling","Blue Bull Energy","Idea Flatpacks","Samsong Electronics","Adobo Systems","Whatsupp Messaging"];

export const CLIENT_CAP=r=>3+r*2; // the book grows with your rank: 3 → 11
export const buildClientPool=()=>shuffle(CLIENT_NAMES);
